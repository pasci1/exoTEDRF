...
def main():
    ...
    if args.instrument == "NIRISS":
        ...
        param_ranges.update({
            ...
            'time_rejection_threshold': list(range(10,31,1)), # works           
...
def main():
    ...
    # Logging
    logf = open("Output_Big/Cost_w1_1.0_w2_0.0_K60.txt", "w")
    logf.write("\t".join(param_order) + "\tduration_s\tcost\n")
    ...
    for key in param_order:
        ...
        for trial in param_ranges[key]:
            ...
            if best_cost is None or cost < best_cost:
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)           
                plt.savefig("Output_Big/norm_white_w1_1.0_w2_0.0_K60.png", dpi=300)
                plt.close()
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)                # turn on the grid
                plt.savefig("Output_Big/norm_white_error_w1_1.0_w2_0.0_K60.png", dpi=300)
                plt.close()
                ...
                plt.ylabel("Integration Number")
                plt.title("Normalized Flux Image")
                plt.savefig("Output_Big/flux_w1_1.0_w2_0.0_K60.png", dpi=300)
                plt.close()
...
def main():
    ...
    # Logging
    logf = open("Output_Big/Cost_w1_0.0_w2_1.0_K60.txt", "w")
    logf.write("\t".join(param_order) + "\tduration_s\tcost\n")
    ...
    for key in param_order:
        ...
        for trial in param_ranges[key]:
            ...
            if best_cost is None or cost < best_cost:
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)           
                plt.savefig("Output_Big/norm_white_w1_0.0_w2_1.0_K60.png", dpi=300)
                plt.close()
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)                # turn on the grid
                plt.savefig("Output_Big/norm_white_error_w1_0.0_w2_1.0_K60.png", dpi=300)
                plt.close()
                ...
                plt.ylabel("Integration Number")
                plt.title("Normalized Flux Image")
                plt.savefig("Output_Big/flux_w1_0.0_w2_1.0_K60.png", dpi=300)
                plt.close()
...
def main():
    ...
    # Logging
    logf = open("Output_Big/Cost_w1_0.5_w2_0.5_K100.txt", "w")
    logf.write("\t".join(param_order) + "\tduration_s\tcost\n")
    ...
    for key in param_order:
        ...
        for trial in param_ranges[key]:
            ...
            if best_cost is None or cost < best_cost:
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)           
                plt.savefig("Output_Big/norm_white_w1_0.5_w2_0.5_K100.png", dpi=300)
                plt.close()
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)                # turn on the grid
                plt.savefig("Output_Big/norm_white_error_w1_0.5_w2_0.5_K100.png", dpi=300)
                plt.close()
                ...
                plt.ylabel("Integration Number")
                plt.title("Normalized Flux Image")
                plt.savefig("Output_Big/flux_w1_0.5_w2_0.5_K100.png", dpi=300)
                plt.close()
...
def main():
    ...
    # Logging
    logf = open("Output_Big/Cost_w1_0.0_w2_1.0_K100.txt", "w")
    logf.write("\t".join(param_order) + "\tduration_s\tcost\n")
    ...
    for key in param_order:
        ...
        for trial in param_ranges[key]:
            ...
            if best_cost is None or cost < best_cost:
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)           
                plt.savefig("Output_Big/norm_white_w1_0.0_w2_1.0_K100.png", dpi=300)
                plt.close()
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)                # turn on the grid
                plt.savefig("Output_Big/norm_white_error_w1_0.0_w2_1.0_K100.png", dpi=300)
                plt.close()
                ...
                plt.ylabel("Integration Number")
                plt.title("Normalized Flux Image")
                plt.savefig("Output_Big/flux_w1_0.0_w2_1.0_K100.png", dpi=300)
                plt.close()
...
def main():
    ...
    # Logging
    logf = open("Output_Big/Cost_w1_0.0_w2_1.0_K200.txt", "w")
    logf.write("\t".join(param_order) + "\tduration_s\tcost\n")
    ...
    for key in param_order:
        ...
        for trial in param_ranges[key]:
            ...
            if best_cost is None or cost < best_cost:
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)           
                plt.savefig("Output_Big/norm_white_w1_0.0_w2_1.0_K200.png", dpi=300)
                plt.close()
                ...
                plt.title("Normalized White-light Curve with Errobar")
                plt.grid(True)                # turn on the grid
                plt.savefig("Output_Big/norm_white_error_w1_0.0_w2_1.0_K200.png", dpi=300)
                plt.close()
                ...
                plt.ylabel("Integration Number")
                plt.title("Normalized Flux Image")
                plt.savefig("Output_Big/flux_w1_0.0_w2_1.0_K200.png", dpi=300)
                plt.close()
